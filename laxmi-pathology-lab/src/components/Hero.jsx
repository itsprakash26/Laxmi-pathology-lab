      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-2 lg:px-8 lg:py-15">
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="mx-auto mt-5 max-w-xl text-base leading-7 text-gray-600 sm:text-lg lg:mx-0">
            Get accurate and reliable laboratory tests with
            professional care. Book your test online and receive
            your reports conveniently.
          </p>

          {/* Buttons */}
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center lg:justify-start">

            <button className="rounded-lg bg-red-600 px-7 py-3.5 font-bold text-white shadow-md transition hover:bg-red-700 hover:shadow-lg active:scale-95">
              Book a Test Now
            </button>

            <button className="rounded-lg border-2 border-red-600 bg-white px-7 py-3.5 font-bold text-red-600 transition hover:bg-red-50 active:scale-95">
              Download Report
            </button>
